...
- **Data table ("the ticket rail"):**
  ...
  - **Below `sm`:** two columns. The left cell holds the burger (ui-m 600), the index tag, "restaurant · neighborhood" (ui-s muted) and the source badge. The right cell holds the price chip.
